export default {
  ...
  import: {
    ...
    verifySeed: 'Vérifier votre seed',
    verifySubtitle: 'Vérifiez votre phrase de récupération pour vous assurer qu\'elle est correcte.',
    enterSeed: 'Entrez votre phrase de récupération pour vérifier. Vous pourrez l\'exporter par la suite.',
